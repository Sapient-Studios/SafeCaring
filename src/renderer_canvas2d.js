...
const COLOR_PALETTE = ["#111111", "#800000", "#469990", "#e6194b", "#42d4f4", "#fabed4", "#aaffc3", "#9a6324", "#000075", "#f58231", "#4363d8", "#ffd8b1", "#dcbeff", "#808000", "#ffe119", "#911eb4", "#bfef45", "#f032e6", "#3cb44b", "#a9a9a9"];
export class RendererCanvas2d {
	...
	flip(videoWidth, videoHeight) {
		...
		this.scatterGLEl.style.display = "inline-block";
	}
	...
	drawSkeleton(keypoints, poseId) {
		...
		const color = params.STATE.modelConfig.enableTracking && poseId != null ? COLOR_PALETTE[poseId % 20] : "White";
